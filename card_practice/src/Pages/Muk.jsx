        ...
        <div className="container mx-auto px-4 py-30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 bg-white rounded-2xl shadow-lg overflow-hidden">
              <img 
                src="https://i.pinimg.com/1200x/d2/c1/b6/d2c1b63e220f2f9d915b51cad07d9302.jpg" 
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img 
                src="https://i.pinimg.com/1200x/66/cb/a4/66cba4486c2724d7565a0fae0901a3a1.jpg" 
                alt="muktinath" 
                className="w-full h-40 object-cover"
              />
              <div className="p-4">
                <h3 className="text-xl font-semibold">Muktinath Temple</h3>
