function BookA(){
    return(
        <>
  {/* this is code forr adding video */}
...
<div className="relative h-screen w-full overflow-hidden bg-black">
  ...
  >
    <source src="/backgroundpp.mp4" type="video/mp4" />
 ...
 <div className="mx-auto w-full max-w-[550px] bg-white bg-opacity-90 backdrop-blur-md rounded-lg p-6">
